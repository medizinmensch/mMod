function main(params) {
	...
	var polygon2 = CAG.fromPoints ( [[3,-8.517], [3,-3.517], [-3,-3.517], [-3,-8.517] ] );
...
function getParameterDefinitions() {
	return [
		...
		{ name: 'circle1_CenterY', caption: 'Y-Coordinate of circle1', type: 'float', initial: '-12.517', step: 0.1 },
		...
		{ name: 'circle3_CenterY', caption: 'Y-Coordinate of circle3', type: 'float', initial: '-12.419', step: 0.1 },
